  ...
  return (
    <>
      <Hero title="About"
        ...
        photo={{
          imgUrl: "/images/about.png", user_link: "https://unsplash.com/@erastus?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText",
          link: "https://unsplash.com/?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText", name: "Erastus McCart"
        }}
      />
      <Team />
    </>
